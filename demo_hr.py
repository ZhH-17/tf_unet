...
data_provider = ImageDataSingle("./data/cj_right_all.png", "./data/cj_right_all_gt.png")
...
trainer = unet.Trainer(net, optimizer="adam", batch_size=3, verification_batch_size=3, opt_kwargs=dict(learning_rate=0.002))
if not predict_only:
